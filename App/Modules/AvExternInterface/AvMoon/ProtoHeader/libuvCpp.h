...
CNetUvMutex_t		CNetUvMutexCreate();
void				CNetUvMutexLock(CNetUvMutex_t mutex);
void				CNetUvMutexUnlock(CNetUvMutex_t mutex);
int					CNetUvMutexTrylock(CNetUvMutex_t mutex);
void				CNetUvMutexRelease(CNetUvMutex_t mutex);
void				uv_msleep(int ms);

#define CNetUvSem_t void *
CNetUvSem_t			CNetUvSemCreate();
int					CNetUvSemWait(CNetUvSem_t sem);
int					CNetUvSemPost(CNetUvSem_t sem);
int					CNetUvSemRelease(CNetUvSem_t sem);

typedef void(* ThreadTask_t)(void *args);

int CnetUvThreadCreate(ThreadTask_t Func, void *args);
